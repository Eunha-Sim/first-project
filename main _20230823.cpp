...
pair<double, double> Kanayama(double K_y, double K_th, double ref_velo) {
    ...
    outputFile << curvature << endl; // 파일에 데이터 입력
...
//N: prediction horizon
    ...
    SX Q = SX::diag({26, 26, 38, 0.0006});  //55.0, 60.0, 60.5, 0.0002
    SX R = SX::diag({0.0, 0.0});
    SX R_u = SX::diag({200, 100});
...
{   
    ...
    outputFile.open("/home/dyros/data_seh_curvature.txt", std::ios::app); //파일 여는 건 여기다 두자.
